...
input_ids = pad_sequences(encoded_ids, maxlen = MAX_LEN, dtype = "long", truncating ="pre", padding = "post", value = 0)
...
batch_size = 10 #Fit as many as possible into memory
...
model = XLNetForSequenceClassification.from_pretrained("xlnet-base-cased",
                                                      num_labels = 2,
                                                      dropout = .1) #Start with default dropout
