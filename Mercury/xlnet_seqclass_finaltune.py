...
def plotResults(train_loss_set, train_acc_set, test_loss_set, test_acc_set):
    loss_fname = "/loss_optim{}_bsizeiter{}.png".format(optim, bsize_iter)
    acc_fname = "/accuracy_optim{}_bsizeiter{}.png".format(optim, bsize_iter)
...
model_settings_list = [ {'optim': "RMSprop", 'bsize_iter':16},
                        {'optim':"AdamW", 'bsize_iter':16}]
#Set seed
seed_val = 2
...
for i in range(len(model_settings_list)):
    ...
    epochs = 100 #Solved overfitting with gradient accumulation - now implement early stopping
