...
def plotResults(train_loss_set, test_loss_set, train_acc_set, test_acc_set):
    ...
    acc_fname = "accuracy_maxlen{}.png".format(size)
...
train_dataloader, validation_dataloader = loadData(5, train_inputs, validation_inputs, train_labels, validation_labels, train_masks, validation_masks)
